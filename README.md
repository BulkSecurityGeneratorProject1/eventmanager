...
This application you can find documentation and help at [http://www.exteam.fr](http://www.exteam.fr).
...
To optimize the eventmanager application for production, run:
