...
import io.eventmanager.config.audit.AuditEventConverter;
import io.eventmanager.domain.PersistentAuditEvent;
...
import static io.eventmanager.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
