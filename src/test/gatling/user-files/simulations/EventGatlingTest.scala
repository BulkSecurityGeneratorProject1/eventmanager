...
class EventGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Event entity")
        ...
        .repeat(2) {
            ...
            .post("/api/events")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "event":"SAMPLE_TEXT", "description":"SAMPLE_TEXT", "numberOfPlaces":"0", "numberOfPlacesRemaining":"0", "latitude":null, "longitude":null, "startEvent":"2020-01-01T00:00:00.000Z", "endEvent":"2020-01-01T00:00:00.000Z", "imageUrl":"SAMPLE_TEXT", "others":"SAMPLE_TEXT", "privateEvent":null, "statusEvent":null, "created":"2020-01-01T00:00:00.000Z"}""")).asJSON
            .check(status.is(201))
