...
import { EventType, EventTypeService } from '../type';
import { EventMedia, EventMediaService } from '../media';
...
export class EventDialogComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.eventMediaService.query()
            .subscribe((res: ResponseWrapper) => { this.eventmedias = res.json; }, (res: ResponseWrapper) => this.onError(res.json));
    }
    ...
    trackEventMediaById(index: number, item: EventMedia) {
        return item.id;
    }
}
